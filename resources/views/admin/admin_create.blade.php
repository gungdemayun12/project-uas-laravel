...
<div class="max-w-2xl mx-auto py-10">
    ...
    <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-black/[0.03] border border-white p-10 relative overflow-hidden">
        <div class="relative z-10">
            <div class="mb-10">
                <h2 class="text-3xl font-black text-[#4A3428] tracking-tighter uppercase text-center">Tambah Akun Admin</h2>
                <div class="w-16 h-1 bg-[#D9B382] mx-auto mt-4 rounded-full"></div>
                <p class="text-[#4A3428]/40 text-[10px] font-black tracking-[0.3em] uppercase mt-4 italic text-center">Pembuatan Akun Pengelola Baru</p>
            </div>

            <form action="{{ route('dashboard.admin.store') }}" method="POST" class="space-y-6">
                @csrf
                <div class="space-y-6">
                    <div>
