...
<body class="bg-pattern min-h-screen flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-10">
            ...
            <h1 class="text-3xl font-black text-[#4A3428] tracking-tighter uppercase">Customer Register</h1>
            <p class="text-[#4A3428]/50 text-sm font-bold tracking-widest uppercase mt-2">Buat akun pelanggan baru</p>
        </div>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-[#4A3428]/10 p-10 border border-[#D9B382]/20 relative overflow-hidden">
            ...
            <form action="{{ url('/customer/register') }}" method="POST" class="space-y-6 relative">
                ...
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-[#4A3428] uppercase tracking-[0.2em] ml-2">Username</label>
                    <div class="relative">
                ...
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-[#4A3428] uppercase tracking-[0.2em] ml-2">Konfirmasi Password</label>
                    <div class="relative">
                ...
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-[#4A3428] uppercase tracking-[0.2em] ml-2">Nomor Telepon</label>
                    <div class="relative">
                ...
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-[#4A3428] uppercase tracking-[0.2em] ml-2">Alamat Lengkap</label>
                    <div class="relative">
                        <textarea name="alamat" rows="3"
                            class="w-full pl-6 pr-6 py-4 rounded-2xl bg-[#fdfaf5] border-2 border-transparent focus:border-[#D9B382] focus:bg-white outline-none transition-all font-bold text-[#4A3428] shadow-inner">{{ old('alamat') }}</textarea>
                    </div>
                    @error('alamat')
                        <p class="text-red-500 text-[10px] font-bold mt-1 ml-2 uppercase">{{ $message }}</p>
                    @enderror
